...
func NewFarmerController(farmerRepo *repositories.FarmerRepository, otpRepo *repositories.OTPRepository) *FarmerController {
...
// Signup handles POST /api/signup — registers a new farmer.
